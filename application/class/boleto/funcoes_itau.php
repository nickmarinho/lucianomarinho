...
// Algumas funcoes foram retiradas do Projeto PhpBoleto e modificadas para atender as particularidades de cada banco
function digitoVerificador_barra($numero)
{
	$resto2 = modulo_11($numero, 9, 1);
	$digito = 11 - $resto2;
	if($digito == 0 || $digito == 1 || $digito == 10  || $digito == 11){ $dv = 1; }
	else{ $dv = $digito; }
...
function formata_numero($numero,$loop,$insert,$tipo = "geral")
{
	...
	if($tipo == "convenio"){ while(strlen($numero)<$loop){ $numero = $numero . $insert; } }
...
function fbarcode($valor)
{
	...
	//Guarda inicial
	/*
	 * nao mexer no layout dessa porra senao caga tudo o codigo de barras
	 * Luciano Marinho - 2011-11-01 05:03
	 */
...
src="/img/boleto/b.png" width="<?php echo $fino; ?>" height="<?php echo $altura; ?>" border="0" /><img <?php
	$texto = $valor ;
	 ...
	 * Luciano Marinho - 2011-11-01 05:03
	 */
?> src="/img/boleto/p.png" width="<?php echo $f1; ?>" height="<?php echo $altura; ?>" border="0" /><img <?php
	 ...
	 * Luciano Marinho - 2011-11-01 05:03
	 */
?> src="/img/boleto/b.png" width="<?php echo $f2; ?>" height="<?php echo $altura; ?>" border="0" /><img <?php
		}
	}
...
src="/img/boleto/b.png" width="<?php echo $fino; ?>" height="<?php echo $altura; ?>" border="0" /><img 
src="/img/boleto/p.png" width="<?php echo 1; ?>" height="<?php echo $altura; ?>" border="0" /><?php
} //fim funcao
...
{ 
	...
	for($i = strlen($num); $i > 0; $i--)
	{
		...
		if($fator == 2){ $fator = 1; }
		else{ $fator = 2; } // intercala fator de multiplicacao (modulo 10)
	}
...
function modulo_11($num, $base=9, $r=0)
{
	...
	for($i = strlen($num); $i > 0; $i--)
	{
		...
		if($fator == $base){ $fator = 1; } // restaura fator de multiplicacao para 2
